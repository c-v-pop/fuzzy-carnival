  ...
  <nav class="bg-gray-800">
    ...
    <div class="md:hidden" id="mobile-menu">
      <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
        ...
        <a href="/about.php" class="bg-gray-900 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">About</a>
        <a href="/contact.php" class="bg-gray-900 text-white text-gray-300 hover:bg-gray-700 rounded-md px-3 py-2 text-sm font-medium">Contact</a>
      </div>
